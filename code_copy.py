...
bottom_customers = bottom_customers_spen.sort_values(ascending = False).tail(10)
plt.figure(figsize=(10,8))
...
print(max_discount_by_month)
print(mean_discount_by_month)
print(max_spend_in_month)
